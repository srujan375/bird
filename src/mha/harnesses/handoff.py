...
`.mha/sessions/<run_id>/bundle/architecture.md`; a code session seeds itself
...
decision. Both `mha code --from-arch` and the lead's `code` tool use it.
"""
