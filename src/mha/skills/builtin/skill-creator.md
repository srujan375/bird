...
Create and improve mha skills with test-driven process design. A skill is
...
- Project skills: `.mha/skills/<name>.md` (version-controlled, shared with the team)
- User skills: `~/.mha/skills/<name>.md` (personal, cross-project)
- Built-in skills: ship with mha (like this one)
...
```
write {"path": ".mha/skills/<name>.md", "content": "<front-matter + body>"}
```
