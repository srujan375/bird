...
Create and improve ox skills with test-driven process design. A skill is
...
- Project skills: `.ox/skills/<name>.md` (version-controlled, shared with the team)
- User skills: `~/.ox/skills/<name>.md` (personal, cross-project)
- Built-in skills: ship with ox (like this one)
...
```
write {"path": ".ox/skills/<name>.md", "content": "<front-matter + body>"}
```
